...
Section ltl_primitives.
  ...
  | ltl_always_def_here s : P ⟨s⟩ → ltl_always_def P ⟨s⟩
  | ltl_always_def_cons s l tr : P (s -[l]-> tr) → ltl_always_def P tr → ltl_always_def P (s -[l]-> tr).
...
Section ltl_lemmas.
  ...
  Proof.
    ...
    { constructor. inversion Htr; simplify_eq. by apply H1. }
    constructor.
    - inversion Htr; simplify_eq. apply H3. done.
  ...
  Proof.
    ...
    inversion Htr; simplify_eq; done.
  Qed.
